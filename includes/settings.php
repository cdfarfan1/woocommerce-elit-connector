...
function nb_options_page()
{
    ...
    echo '<td><input type="number" name="nb_markup_percentage" id="nb_markup_percentage" value="' . esc_attr(get_option('nb_markup_percentage', 35)) . '" min="0" max="100" /> %';
